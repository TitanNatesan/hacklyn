...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # ==================== Create Skills ====================
        skills_data = [
            'Python', 'JavaScript', 'TypeScript', 'React', 'Next.js', 'Django', 'FastAPI',
            'Node.js', 'Express', 'MongoDB', 'PostgreSQL', 'MySQL', 'Redis',
            'Docker', 'Kubernetes', 'AWS', 'Azure', 'GCP', 'CI/CD',
            'Machine Learning', 'Deep Learning', 'TensorFlow', 'PyTorch', 'Scikit-learn',
            'Computer Vision', 'NLP', 'GenAI', 'LangChain', 'OpenAI API',
            'Blockchain', 'Solidity', 'Web3.js', 'Ethereum', 'Smart Contracts',
            'React Native', 'Flutter', 'Swift', 'Kotlin', 'Android', 'iOS',
            'UI/UX Design', 'Figma', 'Adobe XD', 'Tailwind CSS', 'Material-UI',
            'GraphQL', 'REST API', 'WebSockets', 'Microservices', 'System Design',
        ...
        institutions_data = [
            ...
            'University of California Berkeley', 'Carnegie Mellon University', 'Georgia Tech',
            ...
            'National University of Singapore', 'Tsinghua University', 'Oxford University',
            'Cambridge University', 'ETH Zurich', 'University of Toronto', 'Waterloo University'
        ]
        ...
        companies_data = [
            ...
            'OpenAI', 'Anthropic', 'DeepMind', 'Stripe', 'Airbnb', 'Uber', 'Lyft',
            'Coinbase', 'Robinhood', 'Square', 'PayPal', 'Shopify', 'Spotify',
            'Adobe', 'Salesforce', 'Oracle', 'IBM', 'Intel', 'NVIDIA', 'AMD',
            'Startup Inc', 'Tech Ventures', 'Innovation Labs', 'Code Factory'
        ]
        ...
        users_data = [
            {
                ...
                'skills': ['Python', 'JavaScript', 'React', 'Django', 'Machine Learning', 'Docker'],
                'github': 'https://github.com/alicedev',
                'linkedin': 'https://linkedin.com/in/alicedev',
                'education': [
                    {'degree': 'B.S. Computer Science', 'institution': 'Stanford University', 'start': '2018', 'end': '2022', 'current': False},
                ],
                'experience': [
                    {'title': 'Software Engineer', 'company': 'Google', 'start': '2022-06', 'end': '', 'current': True, 'desc': 'Working on search infrastructure and ML models.'},
                ],
                'projects': [
                    {'title': 'AI Code Assistant', 'desc': 'Built an AI-powered code completion tool using GPT-4', 'tech': ['Python', 'OpenAI API', 'React'], 'role': 'Lead Developer', 'link': 'https://github.com/alicedev/ai-assistant'},
                ]
            },
            {
                ...
                'location': 'Austin, TX',
                'skills': ['Solidity', 'Web3.js', 'Ethereum', 'React', 'Node.js', 'TypeScript'],
                'github': 'https://github.com/bobchain',
                'linkedin': 'https://linkedin.com/in/bobsmith',
                'twitter': 'https://twitter.com/bobchain',
                'education': [
                    {'degree': 'M.S. Computer Science', 'institution': 'MIT', 'start': '2020', 'end': '2022', 'current': False},
                ],
                'experience': [
                    {'title': 'Blockchain Engineer', 'company': 'Coinbase', 'start': '2022-08', 'end': '', 'current': True, 'desc': 'Developing smart contracts and DeFi protocols.'},
                ],
                'projects': [
                    {'title': 'DeFi Lending Protocol', 'desc': 'Decentralized lending platform with automated market making', 'tech': ['Solidity', 'Web3.js', 'React'], 'role': 'Founder', 'link': 'https://github.com/bobchain/defi-lend'},
                ]
            },
            {
                'username': 'carol_ml',
                ...
                'location': 'Seattle, WA',
                'skills': ['Python', 'TensorFlow', 'PyTorch', 'Computer Vision', 'Deep Learning', 'AWS'],
                'github': 'https://github.com/carolml',
                'linkedin': 'https://linkedin.com/in/carolwilliams',
                'education': [
                    {'degree': 'Ph.D. Machine Learning', 'institution': 'Carnegie Mellon University', 'start': '2019', 'end': '2024', 'current': False},
                ],
                'experience': [
                    {'title': 'ML Research Scientist', 'company': 'OpenAI', 'start': '2024-01', 'end': '', 'current': True, 'desc': 'Research on multimodal AI models.'},
                    {'title': 'ML Intern', 'company': 'Meta', 'start': '2023-06', 'end': '2023-08', 'current': False, 'desc': 'Worked on image recognition systems.'},
                ],
                'projects': [
                    {'title': 'Medical Image Analyzer', 'desc': 'Deep learning model for detecting diseases from X-rays', 'tech': ['Python', 'TensorFlow', 'Computer Vision'], 'role': 'Lead Researcher', 'link': 'https://github.com/carolml/medimage'},
                ]
            },
            {
                ...
                'skills': ['React Native', 'TypeScript', 'Swift', 'Kotlin', 'Firebase', 'UI/UX Design'],
                'github': 'https://github.com/davidmobile',
                'linkedin': 'https://linkedin.com/in/davidbrown',
                'education': [
                    {'degree': 'B.S. Software Engineering', 'institution': 'Georgia Tech', 'start': '2017', 'end': '2021', 'current': False},
                ],
                'experience': [
                    {'title': 'Senior Mobile Developer', 'company': 'Airbnb', 'start': '2021-07', 'end': '', 'current': True, 'desc': 'Leading mobile app development for iOS and Android.'},
                ],
                'projects': [
                    {'title': 'Fitness Tracker Pro', 'desc': 'Cross-platform fitness app with AI-powered workout recommendations', 'tech': ['React Native', 'TypeScript', 'Firebase'], 'role': 'Solo Developer', 'link': 'https://github.com/davidmobile/fitness-pro'},
                ]
            },
            {
                ...
                'skills': ['Figma', 'UI/UX Design', 'React', 'Tailwind CSS', 'JavaScript', 'Adobe XD'],
                'github': 'https://github.com/evedesign',
                'linkedin': 'https://linkedin.com/in/evedavis',
                'website': 'https://evedavis.design',
                'education': [
                    {'degree': 'B.A. Interaction Design', 'institution': 'University of California Berkeley', 'start': '2018', 'end': '2022', 'current': False},
                ],
                'experience': [
                    {'title': 'Product Designer', 'company': 'Stripe', 'start': '2022-09', 'end': '', 'current': True, 'desc': 'Designing payment experiences for millions of users.'},
                ],
                'projects': [
                    {'title': 'Design System Library', 'desc': 'Comprehensive design system with reusable components', 'tech': ['React', 'Tailwind CSS', 'Figma'], 'role': 'Designer & Developer', 'link': 'https://github.com/evedesign/design-system'},
                ]
            },
            {
                ...
                'education': [
                    {'degree': 'B.S. Information Systems', 'institution': 'University of Washington', 'start': '2016', 'end': '2020', 'current': False},
                ],
                'experience': [
                    {'title': 'DevOps Engineer', 'company': 'Netflix', 'start': '2020-06', 'end': '', 'current': True, 'desc': 'Managing cloud infrastructure at massive scale.'},
                ],
                'projects': [
                    {'title': 'Auto-Scaling Platform', 'desc': 'Kubernetes-based auto-scaling solution for microservices', 'tech': ['Kubernetes', 'Docker', 'Python'], 'role': 'Infrastructure Lead', 'link': 'https://github.com/frankdevops/k8s-autoscale'},
                ]
            },
        ]
        ...
        for user_data in users_data:
            ...
            if created:
                ...
                self.stdout.write(f'Created user: {user.username}/password with complete profile')
            users.append(user)
        ...
        for event_data in events_data:
            ...
            if created:
                # Add prizes
                prizes_list = [
                    {'position': '🥇 1st Place', 'reward': '40% of prize pool + Mentorship', 'order': 1},
                    {'position': '🥈 2nd Place', 'reward': '30% of prize pool', 'order': 2},
                    {'position': '🥉 3rd Place', 'reward': '20% of prize pool', 'order': 3},
                    {'position': '🎨 Best Design', 'reward': '5% of prize pool', 'order': 4},
                ...
                # Add sponsors
                sponsor_companies = ['Google', 'Microsoft', 'AWS', 'GitHub', 'Stripe', 'OpenAI']
                tiers = ['Platinum', 'Gold', 'Silver', 'Bronze']
                for i, sponsor_name in enumerate(random.sample(sponsor_companies, min(4, len(sponsor_companies)))):
        ...
        for user in users[2:]:  # Skip first two users (organizers)
            for event in random.sample(published_events, min(2, len(published_events))):
                if not EventApplication.objects.filter(event=event, user=user).exists():
                    status = random.choice(['pending', 'approved', 'approved', 'approved'])  # More approved than pending
                    app = EventApplication.objects.create(
                        event=event,
                        user=user,
                        team_name=f'Team {user.first_name}',
                        role=random.choice(['Developer', 'Designer', 'Full Stack', 'ML Engineer']),
        ...
        for event in published_events[:2]:  # Create teams for first 2 events
            approved_apps = EventApplication.objects.filter(event=event, status='approved')
                ...
                if created:
                    ...
                    Submission.objects.get_or_create(
                        ...
                        defaults={
                            ...
                            'technologies': ', '.join([s.name for s in random.sample(list(skills.values()), 5)]),
                    ...
                    self.stdout.write(f'Created team and submission: {team.name} for {event.name}')
