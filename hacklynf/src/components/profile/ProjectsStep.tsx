            ...
            <Card key={field.id} className="relative group">
                ...
                <CardContent className="space-y-4">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                        <FormItem>
                            <FormLabel>Link to PR/Issue</FormLabel>
                            <FormControl>
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                        <Textarea placeholder="Fixed a bug in..." className="h-20" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
       ...
       <Separator />
         <FormField
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <Textarea 
                    placeholder="List any other awards, certifications, or recognitions..." 
                    className="h-32" 
                    {...field} 
                    />
                </FormControl>
                <FormDescription>Optional. You can list them here.</FormDescription>
                <FormMessage />
                </FormItem>
            )}
        />
