    ...
    const loadEventData = async (eventId) => {
        try {
            ...
            setEvent({
                ...
                description: "A national hackathon focused on AI/ML solutions."
            });
            setApplications([
                {
                    id: 1,
                    ...
                    role: "Developer",
                    motivation: "Excited to build AI solutions!",
                    status: "pending",
                ...
                },
                {
                    ...
                    team_name: "Team Beta",
                    role: "Designer",
                    motivation: "Looking forward to collaborating on innovative projects.",
                    status: "approved",
        ...
        <DashboardLayout>
            <div className="space-y-6 pb-12 animate-fade-in">
                ...
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="icon" onClick={() => router.push("/dashboard/organizer")}>
                                        ...
                                        {applications.length === 0 ? (
                                            ...
                                            applications.map((app) => (
                                                <TableRow key={app.id}>
                                                    ...
                                                    <TableCell>
                                                        {app.team_name || <span className="text-muted-foreground text-xs italic">Individual</span>}
                                                    </TableCell>
